  ...
  <div class="educate-container container">
    <div class="row">
      <div class="site-breadcumb col-sm-8 col-md-9">
        <h1><?php esc_html_e('404','educate');?></h1>
    ...
    <div class="posts-wrap posts-wrap-404">
      <div id="primary" class="content-area-404">
            <h1 class="page-title-404">
              <?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'educate' ); ?>
            </h1>
          <!-- .page-header -->
          <div class="page-content">
            <p>
              <?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'educate' ); ?>
            </p>
            <?php get_search_form(); ?>
          </div>
          <!-- .page-content -->
